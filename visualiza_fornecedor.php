...
<?php
  ...
  $quant = count($sql);
  	if (empty($sql)) { 
		...
		?>
	<tr onmouseover="ChangeColor(this, true);" onmouseout="ChangeColor(this, false);" onclick="DoNav('altera_fornecedor.php?id=<?php echo $pd['id_fornecedor'];?>');">
		<td class="linha espaco" valign="middle"><?php echo $pd['nome_fornecedor']; ?></td>
