...
require 'processos/database.php';
  ...
  $quant = count($sql);
  	if (empty($sql)) { 
		...
		?>
	<tr onmouseover="ChangeColor(this, true);" onmouseout="ChangeColor(this, false);" onclick="DoNav('altera_cota.php?id=<?php echo $ct['id_cotas'];?>');">
		<td class="linha" align="center" valign="middle"><?php echo $ct['mes_cota'].' de '.$ct['ano_cota'];?></td>
		<td class="linha espaco" valign="middle"><?php echo $ct['nome_loja']; ?></td>
...
<!--
function aviso(id) {
  if (confirm ("Deseja realmente excluir cota da loja <?php echo $ct['nome_loja'];?>?")) {
