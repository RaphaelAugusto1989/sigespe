...
<?php
  ...
  $quant = count($sql);
  	if (empty($sql)) { 
		...
		?>
	<tr onmouseover="ChangeColor(this, true);" onmouseout="ChangeColor(this, false);" onclick="DoNav('alterar_condicoes_pagamento.php?id=<?php echo $cond['id_condicoes'];?>');">
		<td class="linha" align="center" valign="middle"><?php echo $cond['cod_condicoes'];?></td>
