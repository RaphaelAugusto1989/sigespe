...
<?php
  ...
  $quant = count($sql);
  	if (empty($sql)) { 
		...
		?>
	<tr onmouseover="ChangeColor(this, true);" onmouseout="ChangeColor(this, false);" onclick="DoNav('altera_pedido.php?id=<?php echo $pd['id_pedidos'];?>');">
		<td class="linha" align="center" valign="middle"><?php echo $pd['num_pedido'];?></td>
		<td class="linha espaco" valign="middle"><?php echo $pd['descricao']; ?></td>
        <td class="linha espaco"><?php echo $pd['nome_loja']; ?></td>
